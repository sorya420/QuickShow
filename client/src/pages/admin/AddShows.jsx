...
const AddShows = () => {
  ...
  const handleRemoveTime = (date, time) => {
    setDateTimeSelection((prev) => {
      ...
      // If no times left for this date, remove the entire date key
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
        ...
        <div className="group flex flex-wrap gap-4 mt-4 w-max">
          {nowPlayingMovies.map((movie) => (
            <div
              ...
              onClick={() => setSeletedMovie(movie.id)}
            >
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-gary-600 px-3 py-2 rounded-md">
